        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ url('field') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Field Picture</label>
